...
db_connection_pool = MySQLConnectionPool(pool_name="db_pool", pool_size=5, **db_config)
...
def send_old_messages(client_socket):
    try:
        ...
        query = "SELECT content, sender, timestamp FROM messages_svc2 ORDER BY timestamp ASC"
